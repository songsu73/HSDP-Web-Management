...
div_indicate_status.setAttribute("style","width:30%;float:left")
div_status.appendChild(div_indicate_status)

const div_indicate_address = document.createElement("div")
div_indicate_address.setAttribute("class","div_part_status")
const p_indicate_address = document.createElement("p")
